module github.com/kitex-contrib/polaris
...
replace github.com/cloudwego-contrib/cwgo-pkg/registry/polaris => github.com/smx-Morgan/cwgo-pkg/registry/polaris v0.0.0-20241016000926-d56ef7e0f578
